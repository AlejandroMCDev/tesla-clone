...
export const Header = () => {
  ...
  return (
    <header id="landing-header" className="py-3 px-10 text-white flex items-center fixed top-0 w-full justify-between z-40">
        <div className="flex flex-grow basis-0">
            <svg className="h-6 w-32 transition-colors duration-500"
                viewBox="0 0 342 35"
        ...
        <nav>
            <ul className="flex text-sm [&>li>a]:transition-colors [&>li>a]:duration-500 [&>li>a]:font-medium [&>li>a]:text-current [&>li>a]:inline-block [&>li>a]:px-4 [&>li>a]:py-2">
                <li><a href="#models">Model S</a></li>
                <li><a href="#model3">Model 3</a></li>
                <li><a href="#modelx">Model X</a></li>
                <li><a href="#modely">Model Y</a></li>
                <li><a href="#energiasolarypowerwall">Powerall</a></li>
